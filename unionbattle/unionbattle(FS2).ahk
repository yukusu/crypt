                                        ...
                                        If (ErrorLevel = 0)
                                        {
                                            Loop, 
                                            {
                                                ...
                                                If (ErrorLevel = 0)
                                                {
                                                    ...
                                                    {
                                                        ;オートノーマルボタンのサーチ
                                                        ImageSearch, anx, any, 35, 744, 166, 879, *100 autono.bmp
                                                        If (ErrorLevel = 0)
                                                        {
                                                            Click, %anx%, %any%
                                                            break
                                                ...
                                                Else
                                                {
                                                    ...
                                                    {
                                                        ;オートノーマルボタンのサーチ
                                                        ImageSearch, , , 42, 1011, 174, 1123, *100 autono.bmp
                                                        If (ErrorLevel = 0)
                                                        {
                                                            break
                                                        }
                                                        ...
                                                        Else
                                                        {
                                                            ...
                                                            {
                                                                ;オートスキルボタンのサーチ
                                                                ImageSearch, asx, asy, 42, 1011, 174, 1123, *100 autosk.bmp
                                                                If (ErrorLevel = 0)
                                                                {
                                                                    Click, %asx%, %asy%, 2
                                                                    Loop, 
                                            ...
                                            ;3.5秒後に左上の敵のアイコンクリック→オートノーマル解除→FS2アイコンにカーソル移動
                                            Sleep, 3500
                                            Click, 1383, 1080
                                            Click, 100, 1070
                                            Click, 1883, 1060, 0
